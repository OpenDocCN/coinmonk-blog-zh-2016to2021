...
我目前负责我们[内部数据科学平台 RAVEN](https://aws.amazon.com/solutions/case-studies/justgiving/) 和生产 ML 系统的交付和架构。这些最初是用 Azure 部署的，但后来托管在 AWS 中。我还以数据科学家的身份深入研究可扩展流分析、ML 和 NLP 算法。
