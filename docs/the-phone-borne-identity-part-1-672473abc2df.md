...
这足以向 Gmail 证明身份，但大多数情况下，身份不需要专门在双方之间来回证明。在大多数情况下，爱丽丝需要向鲍勃证明汤姆所说的关于爱丽丝的一些事情。这种形式的索赔可以被称为“证明”。在现实世界中，证明的一个例子是大学授予你学位。证明可能是日常生活中身份最重要的部分。在现实世界中，如果没有外部认可提供的庄严感，无论是驾照、律师考试证书还是推荐信，都很难有所成就。有些证明是单义的(如上面的例子)，而另一些则需要多方共同签署一个证明(如父母双方为孩子命名)。其他的则是互惠的(如婚姻契约)，甚至更复杂。

**3。对身份和人格的误解**

地铁和 Gmail 的例子可以向我们指出一种对身份的误解:认为身份必须从个人人格的核心开始，然后继续建立与之相关的属性，如出生日期、婚姻状况、公民身份。

我们对身份的直觉认为，身份与人格有着内在的联系，这是由终生的习惯和使用政府身份证的经历形成的:你知道你自己就是 T1，你的驾照与 T2 和 T3 联系在一起，如果你把它放在钱包里，只有你和 T5 可以开车——这似乎足以了解日常生活中的这个话题。在目前的预包装形式中，身份是单一的和基于人格的。看待身份的另一种方式是从它的组成部分来构建它。

在其基础上，“身份”是任何两个(或更多)相关事实之间的可证明的联系，满足给定的对应方。一些身份证明依赖于单个链接，如在 subway 示例中，另一些需要链接到更广泛的证明网络，如在您的 Gmail 帐户的情况下，还有一些需要访问更广泛的网络。

这并不意味着我们可以使用这个框架重建当前的身份系统。这意味着他们*已经是基于这个框架的*，不可能是别的。如果你从一个身份中剥离所有的属性，你最终不会拥有你的核心，光秃秃的自我——你最终会一无所有。身份是一串相互关联的显著陈述和证明，从你的出生到你的死亡证明。

**4。并非所有金子都会发光**

每次你在工作面试中向警察出示你的驾照、你在潜水中心的 PADI 文凭或你的大学文凭时，你的身份从未被直接表达出来，只是通过足够的属性暗示出来。我们不是通过事物的本质，而是通过一系列我们能体验到的属性来分析我们周围事物的真实性。我们不是通过达到想象中的金色，而是通过它的现象学的显著方面来确定黄金是黄金。一个傻瓜可能会被一个公交车站的骗子说服，相信一条项链真的是由黄金制成的，而一个明智的买家会测试它的延展性和比重——以及其他因素。两者都只辨别黄金的足够的属性，从来没有黄金本身。

同样，当你在机场通过海关时，官员会通过一系列属性对你进行筛选，这些属性足以证明你是你所说的那个人——有照片和序列号的护照，可以与数据库进行核对，当你使用该护照出入境时拍摄的桌面摄像头照片，以及我认为海关官员知道的其他标准。理想情况下，他还会对照一份可能持伪造护照入境的嫌疑人名单，对你进行负面调查。如果真品的属性将造假的可能性降低到令人满意的程度，官员会在你的护照上盖章，并祝你旅途愉快，投资者会带着黄金回家。

身份识别系统不需要提供 100%的信心来完成他们的工作。出于特定目的，它们的置信区间可能既低又有用。发动核打击需要一个身份证明协议，该协议必须同时非常安全和快速。你不能错误地发射你的洲际弹道导弹，但你也不能在受到攻击时发射得太晚。大多数其他身份识别程序要求的置信度要低得多，因为错误识别的成本较低，并且可以被视为业务成本的一部分。人类的毁灭不能是做生意的成本的一部分，但是欺诈性的信用卡收费可以。AirBnB 采用脸书和信用卡验证相结合的方式，为其便利的交易提供“足够好”的身份证明。这使得他们容易受到某种程度的欺诈，这比根本不做生意要便宜。

**5。从地铁到政府**

早些时候，我认为你可以通过谷歌建立一个身份档案，其构建模块与乘坐地铁所需的相同:一系列与同一个人相关联的动作，其概率很大。同样的构件也是你与政府认同的基础。在内心深处，没有什么不同，只有更多的纸。

您可能有许多官方文件，其中许多显示了您的外貌，每一份文件都与一个或多个政府数据库中的相应条目相匹配。当一个密码过期时，您可以用旧密码替换它，就像您用旧密码选择新密码一样。如果一个丢失了，其他的组合可以代替它，就像你的 Gmail 密码可以通过备份电子邮件地址、电话号码和安全问题来重置一样。没有一张纸是决定性的，只有足够多的纸结合在一起才能确立你的黄金地位。

如果一切都丢失了，通常可以传唤一些证人来重新证明你的身份:可证明的身份可以作为恢复丢失身份的充分保证(指纹、手写签名、DNA 样本和其他独特特征也有所帮助)。当我们在第 2 部分讨论分散化块链身份时，这将变得非常重要。

创建您的政府帐户与创建 Gmail 帐户略有不同。可以创建任意数量的 Gmail 账户，只要你能证明“你不是机器人”。谷歌不在乎一个人是否注册了多个 Gmail 账户，但政府需要确保一个身份与一个自然人相关联。这通常是通过结合父母的证明(“我是这个婴儿的母亲”)和医院的证明(“这个婴儿是这个女人在我们医院生的”)。这相当于政府的“创建新账户”按钮。政府颁发的身份来自个人或机构与他们自己现有身份的组合证明，以及[“一路向下都是海龟”](https://en.wikipedia.org/wiki/Turtles_all_the_way_down)。

**6。当前身份系统的局限性**

标准身份系统不令人满意吗？除了一些小故障，对于我们大多数人来说，对于我们的大多数需求来说，它们已经足够好了——但是打字机也是如此。

我们对所用工具的期望只与现状的最高可能表现相匹配。现有技术适用于低性能任务，替换它们就像是重新发明勺子。当他们受到高性能要求的压力时，我们会感觉到一定程度的不便，并学会接受这种不便，将其作为生活的一部分，比如背痛、税收和交通堵塞。超出现有性能水平的东西还没有被想到，因此不能让我们失望。如果浏览 YouTube 需要在 VCR 中交换磁带，我们会认为这个系统是一个糟糕的笑话，但 YouTube 永远不会用 VHS 磁带建立起来——回到 90 年代，没有人会抱怨。那我们错过了什么？让我们列出现代身份系统的一些缺点。

*   身份和证明必须由中央机构保证，因此是孤立的。如果你想更改或更正证明，你必须有权限进入一个竖井，如果你想证明这一点，通常也是如此:如果你想进入一个俱乐部，看起来太年轻，保镖可能会相信你的身份证，但严肃的雇主必须与大学本身双重检查大学学位。
*   由于技术和政治原因，孤岛之间无法轻松地相互通信和传输信息，但许多证明需要存储在其他地方的其他证明。每个人都熟悉将证明从政府机构转移到地方政府办公室所需的冗余和劳动密集型文书工作。甚至由私人组织管理的身份也是互不相容的:你作为 Ebay 卖家的名声不能用来在 AirBnB 上租房。PADI 中心需要参考你的政府 ID 来授予你潜水证书，一旦你去另一个中心，你需要你的政府 ID 和 PADI 证书。
*   如果身份信息是孤立的，那么它也是集中的。如果它有价值，集中它为小偷创造蜜罐。如果你的储藏室着火了，到了冬天，你就得向邻居要食物。如果你村里的小麦筒仓着火了，春天来临时，所有人都死了。把小麦储存在筒仓里也比储存在家里更方便，但是纵火犯要想在一百个储藏室里得逞比在一个筒仓里更难。
*   小麦是有形的，如果从筒仓中取出，有人会注意到它不见了。信息是数字化的，可以在所有者不知情的情况下共享。在一个难以货币化的互联网经济中，商业模式已经演变为，筒仓所有者将允许你存储部分身份信息，并免费使用，只要你让他们通过出售这些信息获利。
*   只有少数机构能够提供证明，因为创建证明是劳动密集型的，并且需要单一用途的基础设施。这限制了可以提供给那些非常重要的人的证明的范围，这些证明的效用大于建立一个中央实体来创建、存储和保证它们的成本。原则上，任何人都可以向其他人提供他们认为合适的大大小小的证明。这种证明的积累可以创建重要的声誉链接，但产生和展示它们的成本是令人望而却步的。
*   政府集中的身份管理，无论多么有效，从定义上来说都不如分散的开放服务，就像美国在线为你提供的所有互联网需求的一站式服务不如外部提供的服务。自由市场可以应用于身份认同，以产生类似的改善。
...
任何复杂的新技术都可以从多个角度被成功攻击，而且会被成功攻击。DBIs 是一种开源的社会技术，因此它们是抗脆弱的:它们被测试得越多，失败得越多，它们就越安全。在早期，这将导致一些人失去隐私和金钱，但平衡安全性和易用性的最佳实践将会出现。在最近的“刀”黑客攻击中遭受的巨大损失有望教会我们在一个新的篮子原型中放多少鸡蛋是明智的。
